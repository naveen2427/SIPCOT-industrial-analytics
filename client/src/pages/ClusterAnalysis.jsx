...
const clusters = [
  { name: 'Electronics', label: 'Electronics Hub', count: 5, companies: 450, color: 'bg-blue-500' },
  { name: 'Automotive', label: 'Automotive Hub', count: 4, companies: 380, color: 'bg-emerald-500' },
  { name: 'IT', label: 'IT Hub', count: 3, companies: 290, color: 'bg-purple-500' },
  { name: 'Textiles', label: 'Textile Hub', count: 2, companies: 150, color: 'bg-amber-500' },
  { name: 'All', label: 'Mixed Cluster', count: 10, companies: 680, color: 'bg-slate-500' },
];
      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          {clusters.map((cluster, index) => (
            <motion.div 
              key={index}
              onClick={() => navigate(`/companies?sector=${cluster.name}`)}
            ...
            >
              ...
              <div className="p-4">
                <h3 className="font-bold text-slate-800 text-sm mb-1">{cluster.label}</h3>
